...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup init"]
    pub fn glfwInit() -> rs_ctypes::c_int;
}
extern "C" {
...
extern "C" {
    ...
    pub fn glfwGetVersion(
        major: *mut rs_ctypes::c_int,
        minor: *mut rs_ctypes::c_int,
        rev: *mut rs_ctypes::c_int,
    );
}
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup init"]
    pub fn glfwGetVersionString() -> *const rs_ctypes::c_char;
}
extern "C" {
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup monitor"]
    pub fn glfwGetMonitors(count: *mut rs_ctypes::c_int) -> *mut *mut GLFWmonitor;
}
extern "C" {
...
extern "C" {
    ...
    pub fn glfwGetMonitorPos(
        ...
        xpos: *mut rs_ctypes::c_int,
        ypos: *mut rs_ctypes::c_int,
    );
}
extern "C" {
    ...
    pub fn glfwGetMonitorPhysicalSize(
        monitor: *mut GLFWmonitor,
        widthMM: *mut rs_ctypes::c_int,
        heightMM: *mut rs_ctypes::c_int,
    );
}
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup monitor"]
    pub fn glfwGetMonitorName(monitor: *mut GLFWmonitor) -> *const rs_ctypes::c_char;
}
extern "C" {
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup window"]
    pub fn glfwWindowHint(hint: rs_ctypes::c_int, value: rs_ctypes::c_int);
}
extern "C" {
    ...
    pub fn glfwCreateWindow(
        width: rs_ctypes::c_int,
        height: rs_ctypes::c_int,
        title: *const rs_ctypes::c_char,
        monitor: *mut GLFWmonitor,
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup window"]
    pub fn glfwWindowShouldClose(window: *mut GLFWwindow) -> rs_ctypes::c_int;
}
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup window"]
    pub fn glfwSetWindowShouldClose(window: *mut GLFWwindow, value: rs_ctypes::c_int);
}
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup window"]
    pub fn glfwSetWindowTitle(window: *mut GLFWwindow, title: *const rs_ctypes::c_char);
}
extern "C" {
...
extern "C" {
    ...
    pub fn glfwSetWindowPos(
        window: *mut GLFWwindow,
        xpos: rs_ctypes::c_int,
        ypos: rs_ctypes::c_int,
    );
}
extern "C" {
    ...
    pub fn glfwGetWindowSize(
        window: *mut GLFWwindow,
        width: *mut rs_ctypes::c_int,
        height: *mut rs_ctypes::c_int,
    );
}
extern "C" {
    ...
    pub fn glfwSetWindowSizeLimits(
        window: *mut GLFWwindow,
        minwidth: rs_ctypes::c_int,
        minheight: rs_ctypes::c_int,
        maxwidth: rs_ctypes::c_int,
        maxheight: rs_ctypes::c_int,
    );
}
extern "C" {
    ...
    pub fn glfwSetWindowAspectRatio(
        window: *mut GLFWwindow,
        numer: rs_ctypes::c_int,
        denom: rs_ctypes::c_int,
    );
}
extern "C" {
...
extern "C" {
    ...
    pub fn glfwGetWindowFrameSize(
        window: *mut GLFWwindow,
        left: *mut rs_ctypes::c_int,
        top: *mut rs_ctypes::c_int,
        right: *mut rs_ctypes::c_int,
        bottom: *mut rs_ctypes::c_int,
    );
}
extern "C" {
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup window"]
    pub fn glfwSetWindowUserPointer(window: *mut GLFWwindow, pointer: *mut rs_ctypes::c_void);
}
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup window"]
    pub fn glfwGetWindowUserPointer(window: *mut GLFWwindow) -> *mut rs_ctypes::c_void;
}
extern "C" {
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup input"]
    pub fn glfwGetInputMode(window: *mut GLFWwindow, mode: rs_ctypes::c_int) -> rs_ctypes::c_int;
}
extern "C" {
    ...
    pub fn glfwSetInputMode(
        window: *mut GLFWwindow,
        mode: rs_ctypes::c_int,
        value: rs_ctypes::c_int,
    );
}
extern "C" {
    ...
    pub fn glfwGetKeyName(
        key: rs_ctypes::c_int,
        scancode: rs_ctypes::c_int,
    ) -> *const rs_ctypes::c_char;
}
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup input"]
    pub fn glfwGetKey(window: *mut GLFWwindow, key: rs_ctypes::c_int) -> rs_ctypes::c_int;
}
extern "C" {
...
extern "C" {
    ...
    pub fn glfwCreateCursor(
        ...
        xhot: rs_ctypes::c_int,
        yhot: rs_ctypes::c_int,
    ) -> *mut GLFWcursor;
}
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup input"]
    pub fn glfwCreateStandardCursor(shape: rs_ctypes::c_int) -> *mut GLFWcursor;
}
extern "C" {
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup input"]
    pub fn glfwJoystickPresent(joy: rs_ctypes::c_int) -> rs_ctypes::c_int;
}
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup input"]
    pub fn glfwGetJoystickAxes(joy: rs_ctypes::c_int, count: *mut rs_ctypes::c_int) -> *const f32;
}
extern "C" {
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup input"]
    pub fn glfwGetJoystickName(joy: rs_ctypes::c_int) -> *const rs_ctypes::c_char;
}
extern "C" {
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup input"]
    pub fn glfwSetClipboardString(window: *mut GLFWwindow, string: *const rs_ctypes::c_char);
}
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup input"]
    pub fn glfwGetClipboardString(window: *mut GLFWwindow) -> *const rs_ctypes::c_char;
}
extern "C" {
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup context"]
    pub fn glfwSwapInterval(interval: rs_ctypes::c_int);
}
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup context"]
    pub fn glfwExtensionSupported(extension: *const rs_ctypes::c_char) -> rs_ctypes::c_int;
}
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup context"]
    pub fn glfwGetProcAddress(procname: *const rs_ctypes::c_char) -> GLFWglproc;
}
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup vulkan"]
    pub fn glfwVulkanSupported() -> rs_ctypes::c_int;
}
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @ingroup vulkan"]
    pub fn glfwGetRequiredInstanceExtensions(count: *mut u32) -> *mut *const rs_ctypes::c_char;
}
